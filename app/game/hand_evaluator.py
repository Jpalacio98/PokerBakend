...
# # Evaluar solo con hole cards
# hole_cards = [Card(rank=10, suit='hearts'), Card(rank=10, suit='diamonds')]
# print(HandEvaluator.gen_hand_rank_info(hole_cards))

# # Evaluar en el flop
# community_cards = [Card(rank=9, suit='spades'), Card(rank=8, suit='hearts'), Card(rank=7, suit='clubs')]
# print(HandEvaluator.gen_hand_rank_info(hole_cards, community_cards))

# # Evaluar en el turn
# community_cards.append(Card(rank=6, suit='diamonds'))
# print(HandEvaluator.gen_hand_rank_info(hole_cards, community_cards))

# # Evaluar en el river
# community_cards.append(Card(rank=5, suit='spades'))
# print(HandEvaluator.gen_hand_rank_info(hole_cards, community_cards))
